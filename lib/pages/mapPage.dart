...
class SearchDogParksSettingsDialogState
    ...
    @override
    void initState() {
        PRINT_DEBUG("SearchDogParksSettingsDialogState initState");
        super.initState();
    }
...
class SearchWasteBinsSettingsDialogState
    ...
    @override
    void initState() {
        PRINT_DEBUG("SearchWasteBinsSettingsDialogState initState");
    ...
    void _getImageURLs() async {
        ...
        await http.get(url).then((http.Response response) {
            ...
            if (result.length > 2) {
                ...
                PRINT_DEBUG("_getImageURLs URL's: " + _imageURLs.toString());
            }
        });

        for (int i = 0; i < _imageURLs.length; i++) {
            PRINT_DEBUG("_getImageURLs: '" + _imageURLs[i] + "'");
        }
